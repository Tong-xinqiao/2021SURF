...
np.savetxt("Prediction_k50_1000_80000.csv", u_pred, delimiter=',')

error_u = np.linalg.norm(u_star - u_pred, 2) / np.linalg.norm(u_star, 2)
print('Error u: %e' % (error_u))


# k100 1000_80000 3605.5524 1.864050e-01
# k250 1000_80000 6435.9208 3.057628e-01
# k50 1000_80000    10436.0675 1.731129e-01
# k50 100_10000   1292.9585  1.973159e-01
